...
class SeismicLL(Likelihood):
    ...
    def map_Y_to_f(self, Y):
        ...
        prior_mu = np.array([200, 500, 1600, 2200, 1950, 2300, 2750, 3650], dtype=np.double)
        prior_var = np.array([900, 5625, 57600, 108900, 38025, 52900, 75625, 133225], dtype=np.double)
